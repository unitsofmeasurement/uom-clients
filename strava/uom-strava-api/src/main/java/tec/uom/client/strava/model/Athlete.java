...
/**
 * Model class containing Strava athlete's profile information.
 *
 * @author Werner Keil
 */
...
public class Athlete extends UserProfile {
    ...
    public Athlete(String id, String login, String firstName, String lastName, String email, String avatar_url) {
        super(id, Strava.class);
        this.login = login;
    ...
    /**
     * The Athlete's Strava login
     *
     * @return the user's Strava login
     */
